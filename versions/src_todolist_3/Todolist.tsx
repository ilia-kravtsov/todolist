...
const Todolist: FC<TodolistPropsType> = (props): JSX.Element => {
    ...
    const handlerCreator = (filter: FilteredTasksType): () => void => (): void => props.changeFilter(filter)
        ...
        <div>
            ...
            <div>
                <input value={inputValue}
                       ...
                       onKeyUp={onKeyPressInputHandler}
                       className={inputClass}/>
                <button onClick={addTask}>+</button>
                {errorMessage}
            </div>
            <TasksList tasksData={props.tasksData} removeTask={props.removeTask} changeTasksStatus={props.changeTasksStatus}/>
            <div>
